...
int main() {
	...
	int16_t num2 = INT16_MAX;			// 16비트(1바이트) 크기의 부호 있는 정수형 변수 선언
	int32_t num3 = 2147483647;			// 32비트(1바이트) 크기의 부호 있는 정수형 변수 선언
	int64_t num4 = 9223372036854775807;	// 64비트(1바이트) 크기의 부호 있는 정수형 변수 선언
    ...
    uint32_t num7 = UINT32_MAX;              // 32비트(4바이트) 크기의 부호 없는 정수형 변수 선언
